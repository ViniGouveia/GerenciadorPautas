package com.vinigouveia.gerenciadorpautas.Mail;
...
public class Mail extends javax.mail.Authenticator {
    ...
    public boolean sendE() throws Exception {
        Properties props = _setProperties();

        if (!_user.equals("") && !_password.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {
